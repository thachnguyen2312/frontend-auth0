...
const AUTH0_CLIENT_ID = 'MuQ8GY3EMQUHAIFElFwf37lKeBVszP5K';
const AUTH0_DOMAIN = 'thachnguyen.auth0.com';
...
document.getElementById('btn-private').addEventListener('click', () => {
  ...
  fetch(PRIVATE_ENDPOINT, {
    ...
    .then(response => response.json())
    .then((data) => {
      console.log('token inside', localStorage.getItem('accessToken'));
